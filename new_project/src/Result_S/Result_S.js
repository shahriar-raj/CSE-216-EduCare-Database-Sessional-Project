...
const Result_S = (props) => {
    ...
    useEffect(() => {
        fetch("http://localhost:4000/getresultfromstudent", msg)
        .then(res => res.json())
        .then(datum => {
            console.log(datum);
    ...
    return (
        <div className='trss'>
            ...
            <br />
            <Button variant="outline-dark" className='btn_b_rss' onClick={(e) => { navigate('/student'); }}>Back</Button>
        </div>
    )
