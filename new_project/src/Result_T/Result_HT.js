...
const Result_HT = (props) => {
    ...
    const handleClick = (e) =>{
        ...
        fetch("http://localhost:4000/updatehtmarks", msg1)
        .then(res => res.json())
        .then(datum => {
            console.log(datum);
    ...
    return (
        <div className='RTD'>
            <br />
            <h1 className='HeadRT'><u><b>Hall Test Marks</b></u></h1>
            <br />
            <br />
            <Row className='FM'>
                <Col md>
                    <h3 className='Head2RT'><u> Full Marks: 70</u></h3>
                </Col>
            </Row>
            <br />
            <br />
