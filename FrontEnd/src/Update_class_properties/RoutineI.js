...
const RoutineI = (props) => {
    ...
    useEffect(() => {
        async function fetchdata() {
            const res1 = await fetch("http://localhost:4000/getroutinefromclass", msg)
    ...
    return (
        <div className='rtn_s'>
            ...
            <br />
            <Button variant="outline-dark" className='btn_b_rn' onClick={(e) => { navigate('/classesinside'); }}>Back</Button>
        </div>
    )
}
}

export default RoutineI;